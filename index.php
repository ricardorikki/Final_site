...
<!--  <header class="text-center text-white d-flex masthead" style="background: url(&quot;assets/img/Screen%20Shot%202022-09-28%20at%2011.57.26%20AM.png&quot;) top / contain round;">
        <div class="container my-auto">
            ...
            <div class="col-lg-8 mx-auto">
                <p class="text-faded mb-5"><span style="color: rgb(255, 255, 255);">"Success is no accident. It is hard work, perseverance, learning, studying, sacrifice and most of all, love of what you are doing or learning to do."&nbsp;Pele</span></p><a class="btn btn-primary btn-xl" role="button" href="#services">Find Out More</a>
            </div>
        </div>
    </header> -->
  ...
  <a href="register.php"><img src="assets/img/register.png" alt="HTML tutorial" style="width:100%;height:100%;"></a>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 text-center">
                    <div class="mx-auto service-box mt-5"><i class="fa fa-diamond fa-4x text-primary mb-3 sr-icons" data-aos="zoom-in" data-aos-duration="200" data-aos-once="true"></i>
                        <h3 class="mb-3">Technocial Support</h3>
                        <p class="text-muted mb-0">Provide technical assistance and answers to users questions, assisting users by troubleshooting problems.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 text-center">
                    <div class="mx-auto service-box mt-5"><i class="fa fa-paper-plane fa-4x text-primary mb-3 sr-icons" data-aos="zoom-in" data-aos-duration="200" data-aos-delay="200" data-aos-once="true"></i>
                        <h3 class="mb-3">Network Administration</h3>
                        <p class="text-muted mb-0">Network administration aims to manage, monitor, maintain, secure, and service an organization's network.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 text-center">
                    <div class="mx-auto service-box mt-5"><i class="fa fa-newspaper-o fa-4x text-primary mb-3 sr-icons" data-aos="zoom-in" data-aos-duration="200" data-aos-delay="400" data-aos-once="true"></i>
                        <h3 class="mb-3">Visual Studio</h3>
                        <p class="text-muted mb-0">Visual Studio is an integrated development environment from Microsoft. It is used to develop computer programs, as well as websites, web apps, web services and mobile apps.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 text-center">
                    <div class="mx-auto service-box mt-5"><i class="fa fa-heart fa-4x text-primary mb-3 sr-icons" data-aos="fade" data-aos-duration="200" data-aos-delay="600" data-aos-once="true"></i>
                        ...
                        <p class="text-muted mb-0">Troubleshooting is a form of problem solving, often applied to repair failed products or processes on a machine or a system.</p>
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section class="text-white bg-dark" style="background: linear-gradient(rgb(0,175,240) 100%, white 100%), rgb(0,175,240);">
        <div class="container text-center">
            <h2 class="mb-4">My Resume</h2>
           
               <a class="btn btn-light btn-xl sr-button" role="button" data-aos="zoom-in" data-aos-duration="400" data-aos-once="true" href="assets/Resume.pdf">Download Now!</a>
        </div>
    </section>
    ...
    <section id="portfolio" class="p-0">
        <div class="container-fluid p-0">
            <div class="row g-0 popup-gallery">
                <div class="col-sm-6 col-lg-4"><a class="portfolio-box" href="assets/img/fullsize/1.png"><img class="img-fluid" src="assets/img/thumbnails/1.jpg">
                ...
                <div class="col-sm-6 col-lg-4"><a class="portfolio-box" href="assets/img/fullsize/2.png"><img class="img-fluid" src="assets/img/thumbnails/2.jpg">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded"><span>Category</span></div>
                                <div class="project-name"><span>Project Name</span></div>
                ...
                <div class="col-sm-6 col-lg-4"><a class="portfolio-box" href="assets/img/fullsize/3.png"><img class="img-fluid" src="assets/img/thumbnails/3.jpg">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded"><span>Category</span></div>
                                <div class="project-name"><span>Project Name</span></div>
                ...
                <div class="col-sm-6 col-lg-4"><a class="portfolio-box" href="assets/img/fullsize/5.png"><img class="img-fluid" src="assets/img/thumbnails/5.png">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded"><span>Category</span></div>
                                <div class="project-name"><span>Project Name</span></div>
   ...
   <iframe allowtransparency=yes scrolling=no
     allowfullscreen=""  marginwidth="0" marginheight="0" src="map.php" width="100%" height="100%"></iframe>
